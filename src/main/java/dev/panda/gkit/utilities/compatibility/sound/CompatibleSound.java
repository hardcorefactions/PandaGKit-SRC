...
public enum CompatibleSound {
    ...
    private CompatibleSound(String sound8, String sound912, String sound13) {
        this.sound8 = sound8;
        this.sound912 = sound912;
        this.sound13 = sound13;
    }

    private CompatibleSound(String sound8, String sound913) {
        this(sound8, sound913, sound913);
    }

    private CompatibleSound(String sound13) {
    ...
    private Sound getSound() {
        if (BukkitUtil.SERVER_VERSION_INT <= 8) {
            return this.sound8 == null ? Sound.valueOf((String)"IRONGOLEM_DEATH") : Sound.valueOf((String)this.sound8);
        }
        if (BukkitUtil.SERVER_VERSION_INT > 9 && BukkitUtil.SERVER_VERSION_INT < 13) {
            return this.sound912 == null ? Sound.valueOf((String)"ENTITY_IRONGOLEM_DEATH") : Sound.valueOf((String)this.sound912);
        }
        if (BukkitUtil.SERVER_VERSION_INT >= 13) {
            return this.sound13 == null ? Sound.valueOf((String)"ENTITY_IRON_GOLEM_DEATH") : Sound.valueOf((String)this.sound13);
        }
        return null;
    }
}
